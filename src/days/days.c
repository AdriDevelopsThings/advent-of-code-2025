...
#include <days/4/part_2.h>
#include <days/5/part_1.h>
#include <days/5/part_2.h>
...
const struct day DAYS[] = {
    ...
    { .day = "4", .part = "1", .f = &days_4_part_1 }, { .day = "4", .part = "2", .f = &days_4_part_2 },
    { .day = "5", .part = "1", .f = &days_5_part_1 }, { .day = "5", .part = "2", .f = &days_5_part_2 }
};
